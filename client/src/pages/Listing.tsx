...
const ListingPage = () => {
	...
	return (
		<main className='bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white'>
			<section className='max-w-screen-2xl min-h-[var(--container-min-height)] mx-auto py-10 md:py-12 px-4 flex flex-col lg:flex-row justify-center items-center gap-8'>
